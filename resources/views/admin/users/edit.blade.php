                                ...
                                <div class="card">
                                        ...
                                        <form class="splash-container" method="POST" action="/admin/users/{{$user->id}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="einputemail" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email', $user->email) }}" required autocomplete="email" placeholder="E-mail">
