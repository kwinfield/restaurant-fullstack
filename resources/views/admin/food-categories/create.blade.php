                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                        ...
                                        <form action="#" id="basicform" data-parsley-validate="">
                                                ...
                                                <input id="inputCategoryImageUrl" type="text" name="image-url" data-parsley-trigger="change" required="" placeholder="http://www.billys.com/img/burgers.jpg" autocomplete="off" class="form-control">
                                                </div>
                                                <div class="row">
