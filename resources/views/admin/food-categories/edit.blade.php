                                ...
                                <div class="card">
                                        ...
                                        <form class="splash-container" method="POST" action="/admin/food-categories/{{$category->id}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="inputimageurl" type="text" class="form-control form-control-lg @error('image_url') is-invalid @enderror" name="image_url"  required autofocus placeholder="Add image url">{{ old('image_url', $category->image_url) }}</textarea>
