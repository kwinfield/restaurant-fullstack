                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-footer">
                                                <p class="display-7 font-weight-bold"><span class="text-primary d-inline-block">Estimated Revenue Last 30 Days {{$estimated_income_last_30}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <tbody>
                                                        @foreach($latestReservations as $reservation)
                                                            <tr>
                                                                ...
                                                                <td>@if($reservation->guest_total > 2)<span class="badge-dot badge-success mr-1"></span>Booth @else<span class="badge-dot badge-brand mr-1"></span>Bar @endif</td>
