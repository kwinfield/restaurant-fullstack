...
Route::get('/confirmed', 'StaticPagesController@reservationConfirmed');
...
View::composer(['home', 'pages/about', 'pages/contact', 'pages/offers', 'pages/reservations', 'thank-you', 'confirmed', 'menu.all-categories', 'menu.single-menu'], function ($view) {
